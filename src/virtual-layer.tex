  ...
  \begin{processbox}{\textsc{virt}}
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        \mathrm{new}}, \pk{\mathrm{right}, \mathrm{fund}, \mathrm{new}}\} + (p +
        s)) \vee (2/\{\pk{\mathrm{left}, \mathrm{rev}}, \pk{\mathrm{right},
        \mathrm{rev}}\})$
...
\begin{center}
  \begin{processbox}{\textsc{virt.siblingSigs}()}
    \begin{algorithmic}[1]
      ...
      $\pk{\mathrm{left}, \mathrm{virt}}$, $\pk{\mathrm{right}, \mathrm{virt}}$,
      $\pk{i, \mathrm{out}}$, $(\pk{h,j,k})_{h \in [n], j \in [n-1] \setminus
      \{1\}, k \in [n-1] \setminus \{1, j\}}$, $(\pk{h, 2, 1})_{h \in [n]}$,
      $(\pk{h, n-1, n})_{h \in [n]}$, $(t_h)_{h \in [n-1] \setminus \{1\}}$)
      \Statex
  ...
  \begin{processbox}{\textsc{virt.hostFundeeSigs}()}
    \begin{algorithmic}[1]
      ...
      \ForAll{$j \in [n-1] \setminus \{1\}$}
        ...
        \mathrm{fund}, \mathrm{new}}$, $\pk{j+1, \mathrm{fund}, \mathrm{new}}$,
        $\pk{\mathrm{left}, \mathrm{virt}}$, $\pk{\mathrm{right},
        \mathrm{virt}}$, $\pk{j, \mathrm{out}}$, $(\pk{h,s,k})_{h \in [n], s \in
