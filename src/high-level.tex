\section{Protocol Description}
  ...
  In more detail, the channel opening protocol steps (Appx.~\ref{sec:protocol},
  Fig.~\ref{code:ln:open}) are as follows: the two counterparties (i) create new signing keypairs and
