  ...
  \begin{processbox}{\textsc{virt}}
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        \State $\texttt{left\_virt\_fast} \gets 2/\{\pk{\mathrm{left},
        \mathrm{virt}, \mathrm{fast}}, \pk{\mathrm{loc}, \mathrm{virt},
        \mathrm{fast}}\}$
        \State $\texttt{left\_virt\_slow} \gets 2/\{\pk{\mathrm{left},
        \mathrm{virt}, \mathrm{slow}}, \pk{\mathrm{loc}, \mathrm{virt},
        \mathrm{slow}}\}$
        \State $\texttt{right\_virt\_fast} \gets 2/\{\pk{\mathrm{sib},
        \mathrm{virt}, \mathrm{fast}}, \pk{\mathrm{right}, \mathrm{virt},
        \mathrm{fast}}\}$
        \State $\texttt{right\_virt\_slow} \gets 2/\{\pk{\mathrm{sib},
        \mathrm{virt}, \mathrm{slow}}, \pk{\mathrm{right}, \mathrm{virt},
        \mathrm{slow}}\}$
        \State $\texttt{guest\_fast} \gets 2/\{\pk{\mathrm{left},
        \mathrm{guest}, \mathrm{fast}}, \pk{\mathrm{right}, \mathrm{guest},
        \mathrm{fast}}\}$
        \State $\texttt{guest\_slow} \gets 2/\{\pk{\mathrm{left},
        \mathrm{guest}, \mathrm{slow}}, \pk{\mathrm{right}, \mathrm{guest},
        \mathrm{slow}}\}$
        \State $\texttt{left\_out} \gets \texttt{left\_virt\_fast} \vee
        (\texttt{left\_virt\_slow} + t)$
        \State $\texttt{right\_out} \gets \texttt{right\_virt\_fast} \vee
        (\texttt{right\_virt\_slow} + t)$
        \State $\texttt{guest\_out} \gets \texttt{guest\_virt\_fast} \vee
        (\texttt{guest\_virt\_slow} + t)$
        ...
        \texttt{right\_out}), ($c_{\mathrm{guest}}$, \texttt{guest\_out}))\}
        \State $\mathrm{TX}_{\mathrm{left}} \gets$ TX \{inputs:
        (($c_{\mathrm{left}} - c_{\mathrm{guest}}$, \texttt{left\_virt\_fast}),
        ($c_{\mathrm{right}}$, \texttt{right\_fund})), outputs:
        (($c_{\mathrm{left}} - c_{\mathrm{guest}}$, \texttt{left\_out}),
        ($c_{\mathrm{right}}$, \texttt{right\_out}))\}
        \State $\mathrm{TX}_{\mathrm{right}} \gets$ TX \{inputs:
        (($c_{\mathrm{left}}$, \texttt{left\_fund}), ($c_{\mathrm{right}} -
        c_{\mathrm{guest}}$, \texttt{right\_virt\_fast}), outputs:
        (($c_{\mathrm{left}}$, \texttt{left\_out}), ($c_{\mathrm{right}} -
        c_{\mathrm{guest}}$, \texttt{right\_out}))\}
        \State $\mathrm{TX}_{\mathrm{both}} \gets$ TX \{inputs:
        (($c_{\mathrm{left}} - c_{\mathrm{guest}}$, \texttt{left\_virt\_fast}),
        ($c_{\mathrm{right}} - c_{\mathrm{guest}}$, \texttt{right\_virt\_fast}),
        ($c_{\mathrm{guest}}$, \texttt{guest\_fast})), outputs:
        (($c_{\mathrm{left}} - c_{\mathrm{guest}}$, \texttt{left\_out}),
        ($c_{\mathrm{right}} - c_{\mathrm{guest}}$, \texttt{right\_out}),
        ...
        $\mathrm{TX}_{\mathrm{both}}$, \TODO{add commitment txs: there's
        probably an undesirable, but an elegant solution may be just around the
        corner})
      \EndIndent
    \end{algorithmic}
  \end{processbox}
