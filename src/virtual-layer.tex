...
\begin{figure}[H]
  \begin{processbox}{\textsc{virt}}
    \begin{algorithmic}[1]
      ...
      \State \textsc{getMidTXs}($c_{\mathrm{left}}$, $c_{\mathrm{right}}$,
      $c_{\mathrm{guest}}$, $\pk{\mathrm{left}, \mathrm{fund}}$,
      $\pk{\mathrm{loc}, \mathrm{fund}}$, $\pk{\mathrm{sib}, \mathrm{fund}}$,
      $\pk{\mathrm{right}, \mathrm{fund}}$, $\pk{\mathrm{left}, \mathrm{virt},
      \mathrm{fast}}$, $\pk{\mathrm{left}, \mathrm{virt}, \mathrm{slow}}$,
      $\pk{\mathrm{loc}, \mathrm{virt}, \mathrm{fast}}$, $\pk{\mathrm{loc},
      \mathrm{virt}, \mathrm{slow}}$, $\pk{\mathrm{sib}, \mathrm{virt},
      \mathrm{fast}}$, $\pk{\mathrm{sib}, \mathrm{virt}, \mathrm{slow}}$,
      $\pk{\mathrm{right}, \mathrm{virt}, \mathrm{fast}}$, $\pk{\mathrm{right},
      \mathrm{virt}, \mathrm{slow}}$, $\pk{\mathrm{left}, \mathrm{guest},
      \mathrm{fast}}$, $\pk{\mathrm{left}, \mathrm{guest}, \mathrm{slow}}$,
      $\pk{\mathrm{right}, \mathrm{guest}, \mathrm{fast}}$, $\pk{\mathrm{right},
      \mathrm{guest}, \mathrm{slow}}$, $\pk{\mathrm{loc}, \mathrm{out}}$):
      \Indent
        \State $\texttt{left\_fund} \gets (c_{\mathrm{left}},
        2/\{\pk{\mathrm{left}, \mathrm{fund}}, \pk{\mathrm{loc},
        \mathrm{fund}}\})$
        \State $\texttt{right\_fund} \gets (c_{\mathrm{right}},
        2/\{\pk{\mathrm{sib}, \mathrm{fund}}, \pk{\mathrm{right},
        \mathrm{fund}}\})$
        \State $\texttt{left\_virt\_full\_fast} \gets (c_{\mathrm{left}},
        2/\{\pk{\mathrm{left}, \mathrm{virt}, \mathrm{fast}}, \pk{\mathrm{loc},
        \mathrm{virt}, \mathrm{fast}}\})$
        \State $\texttt{left\_virt\_full\_slow} \gets (c_{\mathrm{left}},
        2/\{\pk{\mathrm{left}, \mathrm{virt}, \mathrm{slow}}, \pk{\mathrm{loc},
        \mathrm{virt}, \mathrm{slow}}\})$
        \State $\texttt{left\_virt\_less\_fast} \gets (c_{\mathrm{left}} -
        c_{\mathrm{guest}}, 2/\{\pk{\mathrm{left}, \mathrm{virt},
        \mathrm{fast}}, \pk{\mathrm{loc}, \mathrm{virt}, \mathrm{fast}}\})$
        \State $\texttt{left\_virt\_less\_slow} \gets (c_{\mathrm{left}} -
        c_{\mathrm{guest}}, 2/\{\pk{\mathrm{left}, \mathrm{virt},
        \mathrm{slow}}, \pk{\mathrm{loc}, \mathrm{virt}, \mathrm{slow}}\})$
        \State $\texttt{right\_virt\_full\_fast} \gets (c_{\mathrm{right}},
        2/\{\pk{\mathrm{sib}, \mathrm{virt}, \mathrm{fast}}, \pk{\mathrm{right},
        \mathrm{virt}, \mathrm{fast}}\})$
        \State $\texttt{right\_virt\_full\_slow} \gets (c_{\mathrm{right}},
        2/\{\pk{\mathrm{sib}, \mathrm{virt}, \mathrm{slow}}, \pk{\mathrm{right},
        \mathrm{virt}, \mathrm{slow}}\})$
        \State $\texttt{right\_virt\_less\_fast} \gets (c_{\mathrm{right}} -
        c_{\mathrm{guest}}, 2/\{\pk{\mathrm{sib}, \mathrm{virt}, \mathrm{fast}},
        \pk{\mathrm{right}, \mathrm{virt}, \mathrm{fast}}\})$
        \State $\texttt{right\_virt\_less\_slow} \gets (c_{\mathrm{right}} -
        c_{\mathrm{guest}}, 2/\{\pk{\mathrm{sib}, \mathrm{virt}, \mathrm{slow}},
        \pk{\mathrm{right}, \mathrm{virt}, \mathrm{slow}}\})$
        \State $\texttt{guest\_fast} \gets (c_{\mathrm{guest}},
        2/\{\pk{\mathrm{left}, \mathrm{guest}, \mathrm{fast}},
        \pk{\mathrm{right}, \mathrm{guest}, \mathrm{fast}}\})$
        \State $\texttt{guest\_slow} \gets (c_{\mathrm{guest}},
        2/\{\pk{\mathrm{left}, \mathrm{guest}, \mathrm{slow}},
        \pk{\mathrm{right}, \mathrm{guest}, \mathrm{slow}}\})$
        \State $\mathrm{TX}_{\mathrm{none}} \gets$ TX \{inputs:
        (\texttt{left\_fund}, \texttt{right\_fund}), outputs:
        (\texttt{left\_virt\_less\_fast} $\vee$ $(\texttt{left\_virt\_less\_slow}
        + t)$, \texttt{right\_virt\_full\_fast} $\vee$
        $(\texttt{right\_virt\_full\_slow} + t)$,
        \texttt{guest\_fast} $\vee$ $(\texttt{guest\_slow} + t)$)\}
        \State $\mathrm{TX}_{\mathrm{left}} \gets$ TX \{inputs:
        (\texttt{left\_virt\_less\_fast}, \texttt{right\_fund}), outputs:
        (\texttt{left\_virt\_less}, \texttt{right\_virt\_full})\}
        \State $\mathrm{TX}_{\mathrm{right}} \gets$ TX \{inputs:
        (\texttt{left\_fund}, \texttt{right\_virt\_less}),
        outputs: (\texttt{left\_virt\_full},
        \texttt{right\_virt\_less})\}
        \State $\mathrm{TX}_{\mathrm{both}} \gets$ TX \{inputs:
        (\texttt{left\_virt\_less}, \texttt{right\_virt\_less},
        \texttt{guest}), outputs: (\texttt{left\_virt\_less},
        \texttt{right\_virt\_less}, ($c_{\mathrm{guest}},
        \pk{\mathrm{loc}, \mathrm{out}}$)\}
