...
messages to update the state of the channel. Crucially, state
...
important for PCNs since it enables applying the operator to build
...
when the ledger is consistently congested. Without recursiveness and when facing
