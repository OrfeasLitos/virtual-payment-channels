\section{Efficiency Evaluation \& Simulations}
  ...
  recursive and thus can open a virtual channel over many base channels with low
  overhead. In particular, Donner is consistently the most fee-heavy protocol
  and LVPC the slowest. Elmo experiences similar delays to Donner and slightly
  higher fees than LVPC.
