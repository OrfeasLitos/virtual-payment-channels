...
\subsection{Virtual Channels}
  ...
  virtual\TODO{initiator?} transaction ends up on-chain, the latter output carries coins that
  will directly or indirectly fund the funding output of the virtual channel. \TODO{we need to add here a couple of sentences about how updates are performed between the 
  two end-points in the virtual channels.}
