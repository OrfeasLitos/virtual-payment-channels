...
\end{proofsketch}
  ...
  We prove the ``no-halt'' Lemma (Appx.~\ref{sec:proofs},
  \ref{lemma:no-halt}), which informally states that
  if an ideal party is honest, \fchan does not
  ...
  trick is done to \fchan, thus the reduction theorem
  of~\cite{10.1007/978-3-030-90453-1_22} is applicable
