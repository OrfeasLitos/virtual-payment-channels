\TODO{use center and captionof instead of figure, like \textsc{virt}}
\begin{figure}[H]
  ...
  \begin{processbox}{\textsc{ln} -- On (\textsc{close}):}
    \begin{algorithmic}[1]
      ...
      \If{$\texttt{host}_P \neq \ledger$} \Comment{we have a virtual channel}
        ...
        \State input (\textsc{close}) to $\texttt{host}_P$ and keep relaying any
        (\textsc{check if closing}) or (\textsc{close}) input to
