...
\begin{center}
  ...
  $\texttt{sig\_bal}_{\bar{P}}$) by $\bar{P}$:}
    \begin{algorithmic}[1]
      ...
      $\texttt{host}_P$ and expect output (\textsc{coop close revocation},
      \texttt{comms\_revkeys})
      \State extract $\mathrm{sig}_{\bar{P}, R, i}$ from \texttt{comms\_revkeys}
      ...
      $\texttt{host}_P$ and expect output (\textsc{coop close done})
