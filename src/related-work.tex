...
the Turing-complete language of Ethereum.
  ...
  wrt the same environment and subroutines.
...
achieves variadic, but not recursive
  ...
  more efficient than Elmo in terms of storage, computation and communication, and boasts a simpler design.
