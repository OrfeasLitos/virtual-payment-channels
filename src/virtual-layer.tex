  ...
  \texttt{sig\_bal}, \texttt{left\_comms\_revkeys}) by $\bar{P}$:}
    ...
    \begin{algorithmic}[1]
      ...
      \If{$i < n$} \Comment{we are intermediary}
        ...
        txs owned by $\bar{P}$}
        \State extract $\mathrm{sig}_{n, i, \mathrm{left}, \mathrm{rev}}$ from
        \texttt{right\_revocations}
      ...
      \If{$i < n$} \Comment{we are intermediary}
        ...
        $\mathrm{sig}_{i, \mathrm{left}, \mathrm{rev}}$, $\mathrm{sig}_{i,
        \mathrm{left}, R}$)))
      \Else \: \Comment{$i = n$, we are host of fundee}
        ...
        $(\mathrm{sig}_{n, j, \mathrm{left}, \mathrm{rev}})_{j \in \{2, \dots,
        n\}}$))
      \EndIf
      ...
      \Else \: \Comment{$i = n$, we are host of fundee}
        ...
        \State store received signature as $\mathrm{sig}_{\bar{P}, R, i}$
        \Comment{executed by \texttt{fundee}}
        \State \trustedcode{$R_{P, i} \gets$ TX \{input: $C_{\bar{P},
