\section{Security}
  ...
  along with
  all proofs are found in the full version. Informally, it
...
\end{proofsketch}
  ...
  In the full version we prove the ``no-halt'' Lemma, which informally states
  ...
  Our UC-security theorems (found in the full version) state
