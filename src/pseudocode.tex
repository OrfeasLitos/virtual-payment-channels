  ...
  \begin{processbox}{\pchan -- self is $P$}
    ...
    \begin{itemize}
      ...
      \begin{algorithmic}[0]
        ...
        \State Generate and sign virtual and bridge txs ($b$ of
        Fig.~\ref{figure:example-start-end-simple}) for all parties ($O(n^3)$
        txs) with the virtual ($P_V$) and bridge ($P_B$) keys.
