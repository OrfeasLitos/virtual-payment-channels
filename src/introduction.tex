...
\TODO{(i) recommend 5 days for timelock, as LN, (ii) peer discovery independent
(just use LN), (iii) Bitcoin does not support smart contracts due to (a) the
non-Turing-completeness of Script and (b) the lack of covenants}
...
%
  ...
  coins (as~\cite{donner} does), then each party needs exponential
