\section{Efficiency Evaluation}
  ...
  to close its base channel. Note that, in order to only show the costs caused
  by supporting a virtual channel, we subtract the cost the intermediary would
  pay to close its channel if it was not supporting any virtual channel. Lastly,
  we compare the maximum total on-chain cost, aggregated over all parties.
  On-chain cost is measured in terms of size\footnote{For
  ...
  in~\cite{9519487}. We used the tool found in
  ...
  \begin{table}[h!]
    ...
    \multirow{4}{*}{Elmo}
              & \multirow{4}{*}{$6$} &
              \multirow{4}{*}{\shortstack{$\frac{7}{3}n^3-109n^2+$ \\
              $\frac{1435}{3}n-325$}} & \multirow{4}{*}{$33n+444$} &
              \multirow{4}{*}{$6$}
              & \multirow{4}{*}{\shortstack{$\frac{7}{3}n^3-109n^2+$ \\
              $\frac{1336}{3}n-401$}} & \multirow{4}{*}{$33n+444$} &
              \multirow{4}{*}{$12$}
              & \multirow{4}{*}{\shortstack{$\frac{106}{3}n^3-208n^2$ \\
              $+\frac{2302}{3}n-551$}}
              & \multirow{4}{*}{\shortstack{$175(i-2)n^2-$ \\
              $(175i^2-64i-572)n$ \\ $+111(i^2-i-2)$}}
              & \multirow{4}{*}{\shortstack{$\frac{106}{3}n^4-274n^3+$ \\
              $688n^2-1162n+376$}} &
              \multirow{4}{*}{\shortstack{$\frac{175}{6}n^4-281n^3+$ \\
