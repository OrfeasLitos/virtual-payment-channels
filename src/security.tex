\section{Security}
  ...
  We first delineate the security guarantees Elmo provides by proving two
  similar claims regarding the conservation of funds in the real
...
\label{lemma:real-balance-security-informal}
  ...
  \begin{itemize}
    ...
    \item $P$ has received $l$ payments, each involving $c_i$ coins.
  \end{itemize}
...
\label{lemma:ideal-balance-informal}
  ...
  \begin{itemize}
    ...
    transferred $r_i$ coins from the hosted virtual channel to $P$,
    \item $P$ has sent $m$ payments, each involving $d_i$ coins,
    \item $P$ has received $l$ payments, involving $c_i$ coins.
  \end{itemize}
