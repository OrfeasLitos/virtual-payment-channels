    ...
    \begin{algorithmic}[1]
      ...
      \texttt{host\_funder}}
        ...
        \texttt{host\_fundee}}
          ...
          \mathrm{old}}$ from \texttt{left\_data}}
          ...
          n\}}$, $\sk{i, \mathrm{right}, \mathrm{fund}, \mathrm{old}}$)
        ...
        \Else \: \Comment{we are \texttt{host\_fundee}}
          \State parse \texttt{left\_data} as ($(\pk{j, \mathrm{fund},
          \mathrm{new}})_{j \in [n-1]}$, $(\pk{j, \mathrm{left}, \mathrm{fund},
          \mathrm{old}})_{j \in \{2, \dots, n-1\}}$, $(\pk{j, \mathrm{right},
          \mathrm{fund}, \mathrm{old}})_{j \in [n-1]}$, $(\pk{j,
          \mathrm{out}})_{j \in [n-1]}$, $(c_{j, \mathrm{left}})_{j \in \{2,
          \dots, n-1\}}$, $(c_{j, \mathrm{right}})_{j \in [n-1]}$, $(t_j)_{j \in
          [n-1]}$, $\pk{\mathrm{left}, \mathrm{virt}}$, $\pk{\mathrm{right},
          \mathrm{virt}}$)
      ...
      \Else \: \Comment{we are \texttt{host\_funder}}
        ...
        \in \{2, \dots, n-1\}}$, $(t_j)_{j \in \{2, \dots, n\}}$)
