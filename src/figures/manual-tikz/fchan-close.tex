...
\node (open) at (71.5bp,304.5bp) [draw,ellipse] {\textsc{open}};
  ...
  \draw (59.0bp,256.5bp) node {$\environment: \textsc{forceClose}$};
  ...
  \draw (130.0bp,232.0bp) node {$\simulator: (\textsc{forceClose}, P)$};
  ...
  \draw (50.0bp,192.0bp) node {$\simulator: (\textsc{forceClose}, P)$};
