...
\begin{center}
  \begin{processbox}{\textsc{ln} -- On (\textsc{coopClose}):}
    ...
    \begin{algorithmic}[1]
      ...
      \If{we have received at least one of (i) \textsc{open} from $\environment$
      while $\itistate$ was \textsc{topped up}, (ii) \textsc{fund me} or (iii)
      \textsc{virtualising}} \Comment{we are not the \texttt{fundee} of a
