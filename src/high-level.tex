\section{Protocol Description}
  ...
  intermediary (say $D$) and thus needs to be signed by $C$, $D$, and $E$. It produces $4$ outputs: one new funding
  ...
  type, which also needs signatures from all $5$ parties. It has $2$ outputs: one refunds $B$ and
