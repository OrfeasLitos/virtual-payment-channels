...
\begin{center}
  \begin{systembox}{\fchan{} -- general message handling rules}
    \begin{itemize}
      ...
      Fig.~\ref{code:functionality:open},~\ref{code:functionality:pay},~\ref{code:functionality:fund},
      or~\ref{code:functionality:close} (if any) and subsequently send
      ...
      Fig.~\ref{code:functionality:open},~\ref{code:functionality:pay},~\ref{code:functionality:fund},
      or~\ref{code:functionality:close} (if any). After handling the message or
