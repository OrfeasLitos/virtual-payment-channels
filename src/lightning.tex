    ...
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        \textsc{closed}$} \Comment{channel is open}
          ...
          \EndIf
        \EndIf
        \If{activation is not caused by output (\textsc{nothing revoked}),
        received by a member of the list of old hosts $\wedge \itistate =
        \textsc{waiting for nothing revoked}$} \Comment{the only way for this
        case to be true is if the old host punished a misbehaving counterparty}
