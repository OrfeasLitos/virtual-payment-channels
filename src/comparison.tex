...
\section{Efficiency Evaluation}
  ...
  We note that the linear factor when the intermediary closes in the case of our
  work can be eliminated with the aid of Taproot, whereas the same cannot be
  said for the linear factor when the funder closes in Donner.
