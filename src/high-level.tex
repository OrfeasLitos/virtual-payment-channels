\section{Protocol Description}
  ...
  public keys ($A_F, B_F, A_R, B_R$ in Fig.~\ref{figure:payment-layer-simple}). Each then
  ...
  signatures. $A$ then publishes the $F$ on-chain. Once it
  ...
  $5$ parties act as follows. First, they generate and exchange a number of new keys. Then
  ...
  virtual txs will form the \emph{virtual layer}.
  ...
  tx, which needs signatures from all $5$ parties. This tx also
  spends the other, as-of-yet unspent, $C$'s funding output, namely that of
  $(B,C)$ (Fig.~\ref{figure:virtual-layer-extend-interval-simple}, bottom
