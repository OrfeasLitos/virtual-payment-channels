...
Perun~\cite{perun} and GSCN~\cite{DBLP:conf/ccs/DziembowskiFH18}, while more recent work, \cite{cryptoeprint:2020:554}  \TODO{put SP2021 citation, here and below} brought them closer to bitcoin-compatibility (by assuming adaptor signatures, to be available with the Taproot update). 
