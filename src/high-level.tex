...
\subsection{Virtual Channels}
  ...
  its own funding output. In case exactly one of these two outputs is spent
  honestly and the other is unspent,
  ...
  Publishing and extend-interval transaction is the only way for the party to
  close one of its two base channels, of which the funding output is unspent
  ...
  base channels' funding outputs of the party are spent honestly, publishing a merge-intervals
  ...
  is allowed to stay offline between activations without becoming negligent, and
