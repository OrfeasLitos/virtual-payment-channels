    ...
    \begin{algorithmic}[1]
      ...
      \Indent
        ...
        \If{\texttt{funder} is defined}
          ...
          coins and a $2/\{\pk{\mathrm{left}, \mathrm{guest}},
        ...
        \ElsIf{\texttt{fundee} is defined}
          \State ensure that there exists an output with $c_P + c_{\bar{P}} -
          c_{\mathrm{guest}}$ coins and a $2/\{\pk{\mathrm{loc},
          \mathrm{virt}}, \pk{\mathrm{rem}, \mathrm{virt}}\}$ spending method
          with expired/non-existent timelock in $\Sigma$
          \Comment{\texttt{guest}'s output}
          \State ensure that there exists an output with $c_{\mathrm{guest}}$
          coins and a $2/\{\pk{\mathrm{left}, \mathrm{guest}},
          \pk{\mathrm{right}, \mathrm{guest}}\}$ spending method with
