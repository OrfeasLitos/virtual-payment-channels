...
\subsection{Virtual Channels}
  ...
  stemming from Proposition~\ref{prop:liveness} of Appendix), or $p +
  \sum\limits_{j = 2}^{n - 1}(s - 1 + t_j)$ if the intermediary's channel is
  itself virtual, where $t_j$ is the required timelock of the $j$th base channel
