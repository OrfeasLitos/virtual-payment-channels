...
class Elmo(Custom_Elmo_LVPC_Donner):
    ...
    def __init__(
        ...
        coins_for_parties = "max_value", fee_intermediary = 20000,
        opening_transaction_size = 200, elmo_pay_delay = 0.05,
        elmo_new_virtual_channel_delay = 1
    ):
        super().__init__(
            "Elmo", nr_players, max_coins, bitcoin_fee, bitcoin_delay,  coins_for_parties, fee_intermediary,
            opening_transaction_size, elmo_pay_delay, elmo_new_virtual_channel_delay
        )
