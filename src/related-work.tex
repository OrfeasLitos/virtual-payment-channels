...
non-custo\-dial chains (e.g.,~\cite{plasma,konstantopoulos2019plasma,plasma-lower-bounds,rollup}),
  ...
  limited lifetime. Furthermore, due to its incentive structure, none of the
  base channels may close before either the funder of the virtual channel closes
  it, or its limited lifetime expires. Donner also relies on placeholder outputs
