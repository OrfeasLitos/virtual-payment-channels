...
We put forth the first bitcoin-suitable recursive variadic virtual channel construction. Furthermore our virtual channel constructor is symmetric and offers optimal round complexity both in the optimistic and pessimistic execution paths.  Our virtual channels can be implemented over Bitcoin assuming the \texttt{ANYPREVOUT} signature type, a feature that we prove necessary for any protocol that, as in the case of LN, it has parties maintain a set of 
