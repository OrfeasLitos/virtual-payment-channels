...
%
    ...
    \caption{$A$--$E$ virtual channel: One of $C$'s virtual extend-interval
...
%
    ...
    \caption{$A$--$E$ virtual channel: $A$'s virtual initiator tx. Spends the
...
%
    ...
    txs. Spends the virtual outputs of $A$'s and $C$'s virtual
