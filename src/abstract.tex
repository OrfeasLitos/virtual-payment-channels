...
We put forth the first bitcoin-suitable recursive variadic virtual channel constructor. Furthermore our constructor is symmetric and offers optimal round complexity both in the optimistic and pessimistic execution paths.  Our virtual channels can be implemented over bitcoin assuming the \texttt{ANYPREVOUT} signature type. We express and prove the security of our construction in the universal composition setting. 
%
\ignore{  
