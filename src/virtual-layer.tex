    ...
    \begin{algorithmic}[1]
      ...
      are not \texttt{host\_funder}}
        ...
        \texttt{host\_fundee}}
          ...
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{right}}$,
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{both}}$, $C$)}
          ...
          \If{\trustedcode{we have \texttt{right\_virt\_keys}[1]}} \Comment{next
          ...
          \Else \: \Comment{next hop is \texttt{host\_fundee}}
            \State \TODO{use \textsc{virt.getEdgeTXs}() below}
            \State \trustedcode{($\mathrm{TX}_{\mathrm{next}, \mathrm{none}}$,
            $\mathrm{TX}_{\mathrm{next}, \mathrm{left}}$,
            $\mathrm{TX}_{\mathrm{next}, \mathrm{right}}$,
            $\mathrm{TX}_{\mathrm{next}, \mathrm{both}}$, $C$) $\gets$
          ...
          \emptyset$}
          \For{\trustedcode{TX in ($\mathrm{TX}_{\mathrm{next}, \mathrm{left}}$,
          $\mathrm{TX}_{\mathrm{next}, \mathrm{right}}$,
          $\mathrm{TX}_{\mathrm{next}, \mathrm{both}}$, $C$)}}
            \State \trustedcode{add \textsc{sign}(TX, $\sk{\mathrm{loc}}$,
          ...
          \State \trustedcode{($\mathrm{TX}_{\mathrm{loc}, \mathrm{none}}$,
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{left}}$,
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{right}}$,
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{both}}$, $C$) $\gets$
          \textsc{virt.getMidTXs}($c$, $c_A$, $c_B$, \texttt{left\_fund\_keys},
          $\pk{A, F}$, $\pk{B, F}$, \texttt{left\_virt\_keys}[0], $\pk{loc}$,
          $\pk{loc}$, \texttt{right\_virt\_keys}[0], $\pk{A, V}$, $\pk{B, V}$,
          $\pk{loc}$, \texttt{comm\_keys\_loc}, \texttt{comm\_keys\_rem})}
          \For{\trustedcode{TX, $i$ in ($\mathrm{TX}_{\mathrm{loc},
          \mathrm{left}}$, $\mathrm{TX}_{\mathrm{loc}, \mathrm{right}}$,
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{both}}$, $C$)}}
            \State \trustedcode{ensure \textsc{verify}(TX,
            $\mathrm{sigs}_{\mathrm{byRight}}[i]$) = True}
          \EndFor
        ...
        \Else \: \Comment{we are \texttt{host\_fundee}}
          ...
          $\pk{B, V}$, $\pk{loc}$, \texttt{comm\_keys\_loc},
          \texttt{comm\_keys\_rem})
          \State \TODO{use \textsc{virt.getEdgeTXs}() above}
          \For{TX, $i$ in ($\mathrm{TX}_{\mathrm{loc}, \mathrm{left}}$,
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{right}}$,
          $\mathrm{TX}_{\mathrm{loc}, \mathrm{both}}$, $C$)}
            \State ensure \textsc{verify}(TX,
      ...
      \Else \: \Comment{we are \texttt{host\_funder}}
        ...
        $\pk{loc}$, \texttt{right\_virt\_keys}[0], $\pk{A, V}$, $\pk{B, V}$,
        $\pk{loc}$, \texttt{comm\_keys\_loc}, \texttt{comm\_keys\_rem})
        \TODO{use \textsc{virt.getEdgeTXs}() above}
        \For{TX, $i$ in ($\mathrm{TX}_{\mathrm{loc}, \mathrm{left}}$,
        $\mathrm{TX}_{\mathrm{loc}, \mathrm{right}}$,
        $\mathrm{TX}_{\mathrm{loc}, \mathrm{both}}$, $C$)}
          \State ensure \textsc{verify}(TX,
