\section{Efficiency Evaluation \& Simulations}
  ...
  framework\footnote{\url{https://gitlab.com/anonymised-submission-8778e084/virtual-channels-simulation}}
  ...
  Many payments take place on-chain with latency $3600$s and fee $109.5$
  satoshis, thus the high delay and fee values.
