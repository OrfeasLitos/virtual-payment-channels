...
\begin{figure}[H]
  ...
  \{\alice, \bob\}$}
    \begin{algorithmic}[1]
      ...
      \Indent
        \State store $x$
        \label{code:functionality:pay-close:store-pay}
      ...
      \Indent
        \State store $y$
        \label{code:functionality:pay-close:store-get-paid}
      ...
      \Indent
        ...
        paid}, x)\}$}
          ...
          \label{code:functionality:pay-close:decrement}
      ...
      \Indent
        ...
        x)\}$}
          \State $\balance{P} \gets \balance{P} + x$
          \label{code:functionality:pay-close:increment}
          \State \Comment{if $\bar{P}$ honest, this state transition happens
      ...
      \Indent
        ...
        \label{code:functionality:pay-close:check:if}
