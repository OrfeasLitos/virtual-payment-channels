...
\begin{figure*}
  \subimport{./figures/auto-tikz/}{fchan-init.tex}
  \caption{\fchan state machine up to \textsc{init} (both parties)}
  \label{figure:fchan-state-init}
\end{figure*}

\begin{figure*}
  \subimport{./figures/auto-tikz/}{fchan-open-funder.tex}
...
\begin{figure*}
  \subimport{./figures/auto-tikz/}{fchan-open-fundee.tex}
  \caption{\fchan state machine from \textsc{init} up to \textsc{open}
  (fundee)}
