\section{On the necessity of \texttt{ANYPREVOUT}}
  ...
  \begin{proof}[Proof of Theorem~\ref{theorem:anyprevout}]
    ...
    and take its reflexive and transitive closure $\tilde_o$. 
    ...
    $\tilde_o$ that contains $P_{k+1}$. Observe that such party $P_i$ is always
    well defined. 
    %
    ...
    spend a specific output of a specific transaction. 
    
    Since $P_2$ belongs to
