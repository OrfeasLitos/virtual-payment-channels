\section{Future work}
  ...
  Proposition~\TODO{} and therefore cannot be tweaked. However, $p$ represents
  the maximum time between two activations of a non-negligent party, so in
  principle it is possible for the parties to explicitly negotiate this value
  when opening a new channel and even renegotiate it after the channel has been
  opened if need be. We leave this usability-augmenting protocol feature as
  future work.
