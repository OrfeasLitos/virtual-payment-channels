...
% TODO: stress that we here compare the _variadic_ Elmo construction
  ...
  is ignored. \TODO{add "auxiliary data", or specifically what other kind of
  data is counted, if needed} \TODO{see if any optimisations are used by other
  papers, decide if it makes sense to ignore them and change the next phrase}
